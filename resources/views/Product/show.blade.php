        ...
        <div class="row gx-5">
            <aside class="col-lg-6">
                <div class="border rounded-4 mb-3 d-flex justify-content-center">
                    <a data-fslightbox="mygalley" class="rounded-4" target="_blank" data-type="image"
                       href="{{asset("storage/product/{$product->image_product}")}}">
                        <img style="width: 100%; height: 500px; margin: auto; object-fit: cover;" class="rounded-4"
                             src="{{asset("storage/product/{$product->image_product}")}}"/>
                    </a>
                </div>
            ...
            <main class="col-lg-6">
                ...
                4.5
                    ...
                    <div class="mb-3">
                        <span class="h5">Rp. {{$product->product_price}}</span>
                        ...
                        <div class="col-md-4 col-6 mb-3">
                            ...
                            <div class="input-group mb-3" style="width: 170px;">
                                <button class="btn btn-white border border-secondary px-3" type="button"
                                        id="decreaseButton" data-mdb-ripple-color="dark">
                                    <i class="fas fa-minus"></i>
                                </button>
                                <input value="0" type="text" class="form-control text-center border border-secondary"
                                       placeholder="14" aria-label="Example text with button addon"
                                       aria-describedby="decreaseButton" id="quantityInput"/>
                                <button class="btn btn-white border border-secondary px-3" type="button"
                                        id="increaseButton" data-mdb-ripple-color="dark">
                                    <i class="fas fa-plus"></i>
                                </button>
                            </div>
                        </div>
                    </div>
                    <a href="#" class="btn btn-primary shadow-0"> Beli Sekarang </a>
                    <form method="POST" class="d-inline-block" action="{{ url('shopping-cart') }}">
                        @csrf
                        <input class="d-none" type="text" name="product_id" value="{{$product->id}}"/>
                        <input class="d-none" type="text" name="user_id" value="{{request()->user()->id}}"/>
                        <input class="d-none" type="text" name="quantity_sub_product" id="quantitySubProduct">
                        <button type="Submit" class="btn btn-warning shadow-0"><i
                                    class="me-1 fa fa-shopping-basket"></i> Masukan Kedalam Keranjang
                        </button>
                    </form>
                </div>
            </main>
                ...
                <div class="border rounded-2 px-3 py-2 bg-white">
                    ...
                    <div class="tab-content" id="ex1-content">
                        <div class="tab-pane fade show active" id="ex1-pills-1" role="tabpanel"
                            ...
                            <div id="srcData" class="d-none">{{$product->description}}</div>
...
<script>
    ...
    const srcData = document.getElementById('srcData').textContent
    renderElement.innerHTML = srcData
    const quantitySubProduct = document.getElementById('quantitySubProduct')
    ...
    quantitySubProduct.value = parseInt(quantityInput.value)
</script>
</body>
</html>